module "application_gateway" {
  ...
  name                  = coalesce(var.application_gateway_name, "agw-${var.name}")
  ...
  diagnostic_settings     = var.application_gateway_diagnostic_settings
  ...
  public_ip_address_configuration = {
    public_ip_name    = coalesce(var.application_gateway_public_ip_name, "pip-agw-${var.name}")

...
locals {
  ...
  application_gateway_public_ip_domain_name_label = templatestring(local.templates["application_gateway_public_ip_domain_name_label"], local.single_template_vars)
